...
import com.picklemaps.picklemaps_app.domain.dtos.ErrorDto;
import com.picklemaps.picklemaps_app.exceptions.BaseException;
...
import com.picklemaps.picklemaps_app.exceptions.StorageException;
...
public class ErrorController {
    ...
    public ResponseEntity<ErrorDto> handleCourtNotFoundException(CourtNotFoundException ex) {

        log.error("Caught CourtNotFoundException", ex);

        ErrorDto errorDto =
                ErrorDto.builder()
                        .status(HttpStatus.NOT_FOUND.value())
                        .message("The specified court wasn't found")
                        .build();
